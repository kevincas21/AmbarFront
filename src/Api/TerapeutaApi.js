...
export const getTerapeutas = async () => {
    try {
      const response = await axios.get(`${API_BASE_URL}/terapeutas/`,getAuthHeaders());
...
export const createTerapeuta = async (terapeutaData) => {
    try {
      const response = await axios.post(`${API_BASE_URL}/terapeutas/`,terapeutaData,getAuthHeaders());
      return response.data;
    } catch (error) {
...
export const updateTerapeuta = async (id, terapeutaData) => {
    try {
      const response = await axios.put(`${API_BASE_URL}/terapeutas/${id}/`, terapeutaData,getAuthHeaders());
      return response.data;
    } catch (error) {
...
export const deleteTerapeuta = async (id) => {
    try {
      const response = await axios.delete(`${API_BASE_URL}/terapeutas/${id}/`,getAuthHeaders());
      return response.data;
    } catch (error) {
...
export const getTerapeutaById = async (id) => {
    try {
      const response = await axios.get(`${API_BASE_URL}/terapeutas/${id}/`,getAuthHeaders());
      return response.data;
    } catch (error) {
