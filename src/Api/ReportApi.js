...
export const GetReportDateRange = async (startDate, endDate) => {
  try {
    const response = await axios.get(
      `${API_BASE_URL}/reports/turnos_by_date/`,
      {
...
export const GetReportByTerapeuta = async (terapeutaId, startDate, endDate) => {
  try {
    const response = await axios.get(
      `${API_BASE_URL}/reports/turnos_by_terapeuta/${terapeutaId}/`,
      {
        params: { start_date: startDate, end_date: endDate },
        ...getAuthHeaders(),
      }
...
export const GetReportByPaciente = async (pacienteId, startDate, endDate) => {
  try {
    const response = await axios.get(
      `${API_BASE_URL}/reports/turnos_by_cliente/${pacienteId}/${startDate}/${endDate}/`,
      {
        ...getAuthHeaders(),
      }
    );
...
export const GetMostFrequentPaciente = async (startDate, endDate) => {
  try {
    const response = await axios.get(
      `${API_BASE_URL}/reports/clients_most_turnos/${startDate}/${endDate}/`,
      {
        ...getAuthHeaders(),
      }
    );
...
export const GetTerapeutaInfo = async (terapeutaId) => {
  try {
    const response = await axios.get(
      `${API_BASE_URL}/terapeutas/${terapeutaId}/`,
      {
        ...getAuthHeaders(),
      }
    );
